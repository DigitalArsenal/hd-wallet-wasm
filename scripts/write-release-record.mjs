...
function parseCli(arguments_) {
  ...
  if (sourceTag !== 'v2.0.29') throw new Error('source tag must be v2.0.29');
...
async function main() {
  ...
  const registryRecords = {
    'hd-wallet-ui': npmView('hd-wallet-ui', '2.0.29'),
    'hd-wallet-wasm': npmView('hd-wallet-wasm', '2.0.29'),
  };
  const packageInput = (name, artifactName) => {
    ...
    if (!packageEvidence || !artifact || registry.version !== '2.0.29'
